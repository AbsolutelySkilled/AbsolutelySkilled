...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill core-web-vitals
```

3. The core-web-vitals skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
