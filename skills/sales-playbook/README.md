...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill sales-playbook
```

3. The sales-playbook skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
