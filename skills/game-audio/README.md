...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill game-audio
```

3. The game-audio skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
