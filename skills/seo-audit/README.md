...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill seo-audit
```

3. The seo-audit skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
