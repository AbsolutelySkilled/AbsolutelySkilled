...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill content-seo
```

3. The content-seo skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
