...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill on-site-seo
```

3. The on-site-seo skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
