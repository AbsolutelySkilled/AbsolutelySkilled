...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill responsive-design
```

3. The responsive-design skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
