...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill local-seo
```

3. The local-seo skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
