...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill android-kotlin
```

3. The android-kotlin skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
