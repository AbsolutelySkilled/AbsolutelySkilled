...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill color-theory
```

3. The color-theory skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
