...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill react-native
```

3. The react-native skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
