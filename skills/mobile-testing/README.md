...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill mobile-testing
```

3. The mobile-testing skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
