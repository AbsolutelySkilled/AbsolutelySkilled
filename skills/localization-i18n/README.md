...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill localization-i18n
```

3. The localization-i18n skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
