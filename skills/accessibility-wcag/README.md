...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill accessibility-wcag
```

3. The accessibility-wcag skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
