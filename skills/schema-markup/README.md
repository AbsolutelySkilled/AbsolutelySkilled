...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill schema-markup
```

3. The schema-markup skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
