...
```bash
npx skills add AbsolutelySkilled/AbsolutelySkilled --skill ip-management
```

3. The ip-management skill is now available in your AI coding agent (Claude Code, Gemini CLI, OpenAI Codex, etc.).
