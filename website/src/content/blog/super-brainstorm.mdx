---
title: "Super Brainstorm: The Skill That Makes Your AI Think Before It Builds"
description: "How super-brainstorm turns vague feature requests into bulletproof design specs through relentless interviewing, ultrathink reasoning, and mutual confidence gates - before a single line of code is written."
date: "2026-03-29"
author: "maddhruv"
tags: ["skills", "workflow", "planning", "design", "brainstorming", "super-brainstorm"]
---
...
When you invoke super-brainstorm, the agent follows a strict 10-phase process. Here is what each phase does and why it matters.
...
### Phase 10: Hand Off to Super-Human

Once the spec is approved, the agent recommends delegating execution to [super-human](/skill/super-human) - a companion skill purpose-built to take validated specs and execute them through dependency-graphed sub-tasks, parallel waves, and TDD verification.

This creates a clean handoff: super-brainstorm designs, super-human builds.

---

## The 100% Confidence Gate

The most important feature of super-brainstorm is the mutual confidence requirement. Traditional brainstorming ends when the conversation feels "done." Super Brainstorm ends when both parties are provably confident.
...
It is also not for trivial tasks. If the solution is obvious - fix a bug, rename a function, update a dependency - skip super-brainstorm and just do it.

Use it when the task has real design decisions: new features, architecture changes, system redesigns, greenfield projects, major refactors. The threshold is simple: if you would whiteboard it with a colleague before coding, you should super-brainstorm it with your agent.
...
```
/super-brainstorm I want to add a real-time collaboration system to my app
```
...
- [**super-human**](/skill/super-human) - takes the approved spec and executes it with parallel task waves and TDD
- [**writing-plans**](/skill/writing-plans) - alternative execution path if you prefer detailed implementation plans over the full super-human lifecycle
...
Once your spec is ready, read about the execution side: [**Super-Human: An AI-Native SDLC That Actually Ships**](/blog/super-human) - how the companion skill takes your validated design and builds it with parallel wave execution and TDD.
...
<div style="background: linear-gradient(135deg, rgba(59,130,246,0.08), rgba(168,85,247,0.08)); border: 1px solid rgba(59,130,246,0.2); border-radius: 12px; padding: 24px; margin: 32px 0; text-align: center;">
  <p style="font-size: 18px; font-weight: 600; color: var(--color-text-primary); margin-bottom: 8px;">Try super-brainstorm</p>
  <p style="color: var(--color-text-secondary); margin-bottom: 16px;">Install in one command. Design before you build.</p>
  <a href="/skill/super-brainstorm" style="display: inline-block; background: var(--color-accent-blue); color: white; padding: 10px 24px; border-radius: 8px; text-decoration: none; font-weight: 600;">View Skill Page</a>
</div>
