...
[**Super Brainstorm**](/blog/absolute-brainstorm) is the companion skill that handles the design phase. It runs a structured interview with ultrathink reasoning, probing every design decision until both you and the AI are 100% confident. It produces a formal spec, then recommends handing off to Absolute-Human for execution.
